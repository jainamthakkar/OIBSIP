...
class Main {
	...
	public static void main(String[] args) {
		...
		if (rrr == 2) {
			...
			while (n < 6) {
				...
				case 1 -> {
					if (c1 == 0) {
						...
						System.out.println(
								"You've already attempted this test.If you want to review your answers select OPTION-3");
				}
				...
				case 5 -> {
					if (!choices.isEmpty())
						System.out.println("Your final answers are: " + choices);
					else
						System.out.println("You did not attempt a single question.");
				}
			...
			System.out.println("PLEASE COME BACK AGAIN WITH CORRECT CREDENTIALS");
